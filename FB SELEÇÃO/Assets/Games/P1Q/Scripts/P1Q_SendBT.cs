...
public class P1Q_SendBT : MonoBehaviour
{
    public string PATH = "";
    ...
    private void Last()
    {
        ...
        q.IsDone = true;
        q.HitPercentage = (100.0f *P1Q_PointManager.P1Q.Points) / P1Q_PointManager.P1Q.TotalPoints;

        Debug.Log("Salvou Pontuação");
        Debug.Log(P1Q_PointManager.P1Q.Points + "/" + P1Q_PointManager.P1Q.TotalPoints);
